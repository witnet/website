    ...
    ol.questions
      ...
      question
        ...
        main(slot="answer")
          ...
          p Also, "tokenomics" of other projects rely heavily on ERC-20 tokens in the Ethereum blockchain to incentivize oracles to resolve tasks. This fact will hinder their viability until Ethereum's scalability challenges are solved or they accept alternative means of payment.
